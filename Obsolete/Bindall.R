...
lst = list.files("refined/", ".csv", full.names = TRUE)
...
#
 #AL data_unique <- data_compile2 %>% 
#AL  distinct(Latitude,Longitude, .keep_all = TRUE)
...
#setwd("combined/")
write.csv(data_compile2, "data_compile.csv", row.names =F)
